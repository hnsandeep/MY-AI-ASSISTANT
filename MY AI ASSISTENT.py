...
def wish():
    ...
    if h>=0 and h<12:
        voice("Good Morning Sandeep H N ,i am your Assistant,how can i help you")
    elif h>=12 and h<18:
        voice("Good after noon Sandeep H N ,i am your Assistant,how can i help you")
    else:
        voice("Good evening Sandeep H N ,i am your Assistant,how can i help you")
...
# todo file open
    ...
    g = "thank you,for your confirmation , now i am going to open your File manager"
    voice(g)
    subprocess.Popen("explorer")

elif "open installation area" in fun:
    g = "thank you,for your confirmation , now i am going to open your installation area "
    voice(g)
    os.startfile("E:\\")

elif "open coding world" in fun:
    g = "thank you,for your confirmation , now i am going to open your coding world"
    voice(g)
    os.startfile("F:\\")

elif "open college world" in fun:
    g = "thank you,for your confirmation , now i am going to open your college world"
    voice(g)
    os.startfile("G:\\")

# todo webbrowser or internet
elif "open youtube" in fun:
    g = "thank you,let's enjoy , now i am going to open youtube"
    voice(g)
    w.open("http://youtube.com")

elif "open google" in fun:
    g = "thank you,let's go and explore , now i am going to Google"
    voice(g)
    w.open("http://google.com")

elif "open gmail" in fun:
    g = "thank you,for your confirmation , now i am going to open Gmail"
    voice(g)
...
# todo searching or playing
    ...
    f = speek()
    if f == 'google':
        voice("what you want to search, on googlE")
        a = speek()
        voice("ok, i am searching on google" + a)
        w.open("http://google.com/search?q=" + a)
    elif f == 'youtube':
        voice("ok, what you want searching or playing on youtube")
        b = speek()
        if b == "searching":
...
# todo command for system application
    ...
    g = "thank you,for your confirmation , now i am going to open your vs code"
    voice(g)
    path = "C:/Users/hp/AppData/Local/Programs/Microsoft VS Code/Code.exe"
    os.startfile(path)

elif 'open pycharm' in fun:
    g = "thank you,for your confirmation , now i am going to open your pycharm IDE"
    voice(g)
    path = "C:\\Program Files\\JetBrains\\PyCharm Community Edition 2022.1.3\\bin\\pycharm64.exe"
    os.startfile(path)

elif 'open firefox' in fun:
    g = "thank you,for your confirmation , now i am going to open firefox"
    voice(g)
    path = "C:\\Program Files\\Mozilla Firefox\\firefox.exe"
    os.startfile(path)

elif 'open chrome' in fun:
    g = "thank you,for your confirmation , now i am going to open chrome"
    voice(g)
    path = "C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe"
    os.startfile(path)

elif 'open paint' in fun:
    g = "thank you,for your confirmation , now i am going to open paint"
    voice(g)
    path = "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\Paint.lnk"
    os.startfile(path)

elif 'open notepad' in fun:
    g = "thank you,for your confirmation , now i am going to open notepad"
    voice(g)
    path = "C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\Notepad.lnk"
    os.startfile(path)

elif 'open python' in fun:
    g = "thank you,for your confirmation , now i am going to open your python IDE"
    voice(g)
    path = "C:\\Users\\HP\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Python 3.11\\IDLE (Python 3.11 64-bit).lnk"
    os.startfile(path)

elif 'open any disc' in fun:
    g = "thank you,for your confirmation , now i am going to open any disk"
    voice(g)
    path = "C:\\Program Files (x86)\\AnyDesk\\AnyDesk.exe"
    os.startfile(path)

elif 'open java' in fun:
    g = "thank you,for your confirmation , now i am going to open IntelliJ Java"
    voice(g)
...
# todo command promt
    ...
    g = "thank you,for your confirmation , now i am going to open command line"
    voice(g)
